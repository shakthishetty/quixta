...
export const LogoSection = () => {
  ...
  {/* Gradient Line */}
  <div
    className="w-[6px] h-70 md:h-70 rounded-full md:mr-30 md:pr-2"
    style={{
  ...
  {/* Grey Line */}
  <div className="w-[4px] h-70 md:h-80 bg-[#3B3B3B] md:mr-30 md:pr-1" />
</div>
          ...
          <div className="flex-1 p-4 md:pl-6">
            ...
            <div className="space-y-4 md:space-y-6 md:max-w-[70%]">
              <p className="text-lg md:text-4xl font-light text-gray-200 leading-snug text-nowrap">
