...
const Brand = () => {
  ...
  return (
    <>
    <section className="relative w-full bg-black text-white overflow-hidden  pb-20">
      ...
      <div className="relative z-10 px-8 ml-2 md:px-8 lg:px-12 pt-20 md:pt-50 md:ml-40">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-left mb-6 sm:mb-8 md:mb-10 lg:mb-12 ml-2 sm:ml-8 md:ml-12 lg:ml-16 xl:ml-20">
